...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <td><a href="<?php echo _WEB_HOST; ?>?module=users&action=edit&id=<?php echo $item['id']; ?>" class="btn btn_warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a></td>
            <td><a href="<?php echo _WEB_HOST; ?>?module=users&action=delete&id=<?php echo $item['id']; ?>" onclick = "return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn_danger btn-sm"><i class="fa-solid fa-trash"></i></a></td>
            </tr>
        <?php
            endforeach;

    ...
    if(!empty($filterAll['email'])){
        ...
        if(!empty($queryUser)){
            ...
            if($updateStatus){
                ...
                $content = 'Chào bạn.</br>';
                $content .= 'Chúng tôi nhận được yêu cầu đổi mật khẩu. Vui lòng ấn vào đường link sau!</br>';
                ...
                if($sendEmail){
                    setFlashData('msg', 'Vui lòng kiểm tra email để xem hướng dẫn khôi phục mật khẩu');
